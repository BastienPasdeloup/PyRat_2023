...
# [TODO] It is good practice to keep all constants and global variables in an easily identifiable section
...
def postprocessing (maze, maze_width, maze_height, name, teams, player_locations, player_scores, player_muds, cheese, possible_actions, stats) :
